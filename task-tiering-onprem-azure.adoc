...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["Déploiement d'un connecteur dans Azure"^]
...
+
** Connexion HTTPS sur le port 443 vers le service NetApp Cloud Tiering et vers votre stockage objet Azure Blob (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["voir la liste des noeuds finaux"^])
