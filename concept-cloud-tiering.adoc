...
Après avoir acheté une licence de Tiering BlueXP, vous devez utiliser le portefeuille digital de BlueXP pour ajouter la licence. link:task-licensing-cloud-tiering.html#use-a-bluexp-tiering-byol-license["Découvrez comment utiliser une licence de Tiering BlueXP BYOL"].
